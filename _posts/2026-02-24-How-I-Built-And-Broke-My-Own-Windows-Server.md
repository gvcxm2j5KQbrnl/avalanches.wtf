...
<ul style="list-style-type: none; padding: 0;">
      ...
      <div style="margin-top: 15px; display: flex; gap: 10px; justify-content: flex-start;">
        <a href="https://github.com/user-attachments/assets/c0e9423b-0dca-44bc-87af-6639927500c1" target="_blank">
          <img src="https://github.com/user-attachments/assets/c0e9423b-0dca-44bc-87af-6639927500c1" 
               ...
               style="width: 100%; max-width: 700px; border-radius: 8px; border: 1px solid #333;" />
        </a>
      </div>
    </details>
  </li>
  ...
  <li style="margin-bottom: 15px; display: flex; align-items: flex-start;">
    <details style="cursor: pointer; width: 100%;">
      ...
      <div style="margin-top: 15px; background: transparent; overflow: hidden; text-align: left;">
        <a href="https://github.com/user-attachments/assets/2a71da84-c60c-4d12-bdb2-04723fdb8f07" target="_blank">
          <img src="https://github.com/user-attachments/assets/2a71da84-c60c-4d12-bdb2-04723fdb8f07" 
               alt="Arch Linux Info" 
               style="width: 100%; max-width: 600px; border-radius: 4px; border: 1px solid #333;" />
        </a>
      </div>
    </details>
  </li>
...
<div style="display: flex; gap: 10px; margin-top: 15px;">
  <img width="49%" src="https://github.com/user-attachments/assets/a46a1b92-5a62-44db-93f0-b583869bf1ea" style="border-radius: 8px; border: 1px solid #333;" />
  <img width="49%" src="https://github.com/user-attachments/assets/0cf1a9d1-adaf-4736-b2a3-ee3c73b0aa39" style="border-radius: 8px; border: 1px solid #333;" />
</div>
...
<div style="margin-top: 20px; text-align: center;">
  <img width="89%" src="https://github.com/user-attachments/assets/2ca0371e-b478-4b37-8af6-bd6c3d5d9663" style="border-radius: 8px; border: 1px solid #333;" />
</div>
...
<div style="margin-top: 20px; text-align: center;">
  <img width="89%" src="https://github.com/user-attachments/assets/7cdd01e9-4afb-4db8-b73f-0c4eb3db1447" style="border-radius: 8px; border: 1px solid #333;" />
</div>

&nbsp;

# Phase 4: Setting up the Workstation 
The workstation join is the final "Build" boss. Once I authenticated with the Admin credentials, I got the welcome message. The lab was officially alive.
...
With the foundation solid, the "Building" part is over. Now I have to intentionally weaken the security to simulate real-world mistakes. My first target: **Kerberoasting**.
...
<div style="text-align: center; margin-top: 15px;">
  <img src="https://github.com/user-attachments/assets/27f104f3-7fd7-4901-9951-25bdc46660ae" style="width: 100%; max-width: 700px; border-radius: 8px; border: 1px solid #333;" />
</div>

&nbsp;

# Phase 6: Reconnaissance
From my **Arch Linux** host, I bridged into the 10.0.0.0/24 subnet and ran a full Nmap scan.

<div style="text-align: center; margin-top: 15px;">
  <img src="https://github.com/user-attachments/assets/adb6991a-5ba1-43bb-b30c-d656d589f444" style="width: 100%; max-width: 800px; border-radius: 8px; border: 1px solid #333;" />
</div>

&nbsp;

### The Loot: Important Ports
These are the main entry points for AD attacks:
...
## What's Next?
The reconnaissance is done. In the next post, I’ll finally pull the trigger on the **Kerberoasting** attack using Impacket to grab that service account hash. Stay tuned!
