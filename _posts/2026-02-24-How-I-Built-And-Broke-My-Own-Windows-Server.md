...
Now for the actual core: turning the server into a Domain Controller. I used PowerShell for this because it's way faster than clicking through the GUI wizards. I promoted the server to a new Forest for <em><strong>lab.local</strong></em>.
